...
def check_events(ai_settings, screen, ship, bullets, aliens, stats, play_button, sb):
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            check_play_button(ai_settings, screen, ship, bullets, aliens, stats, play_button, mouse_x, mouse_y, sb)

def check_play_button(ai_settings, screen, ship, bullets, aliens, stats, play_button, mouse_x, mouse_y, sb):
...
def create_fleet(ai_settings, screen, aliens, ship):
    ...
    for alien_row in range(number_rows):
        for alien_number in range(number_aliens_x):
            create_alien(ai_settings, screen, alien_width, alien_number, aliens, alien_row)
